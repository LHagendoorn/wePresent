...
public abstract class Mapper extends AsyncTask<Object, Boolean, String> {
    ...
    public enum MapperSort {
        MAPPER, MAINMAPPER, REGISTERMAPPER, SLIDESMAPPER, SESSIONMAPPER, SINGLESLIDEMAPPER, QUESTIONSMAPPER, ADDQUESTIONMAPPER, QUIZMAPPER, UPVOTEMAPPER, SINGLEQUESTIONMAPPER, PRESENTATIONMAPPER, QUESTIONSETMAPPER, UPDATEMAPPER
    }
}
